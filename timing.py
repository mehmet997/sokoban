...
""" time analysis for all levels and all algorithms 
BEWARE: some algorithms don't reach a result, the execution of this file will not end then s"""
...
for algorithm in range(1, 7):
    ...
    for level in range(1, 12):
        ...
        if mode == Mode.BFS:
            ...
            if actions == "cutoff" : print("cutoff")
